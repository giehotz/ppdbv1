...
class Profile extends BaseController
{
    ...
    public function index()
    {
        ...
        if (!$user) {
            return redirect()->to('/admin/dashboard')->with('error', 'Data pengguna tidak ditemukan.');
        }
    ...
    public function updatePassword()
    {
        ...
        if ($this->userModel->update($id_user, ['password' => $hashedPassword])) {
            ...
            return redirect()->to('/admin/profile')->with('success', 'Kata sandi berhasil diperbarui.');
        }
    ...
    public function deleteFoto()
    {
        ...
        if (!empty($user['foto'])) {
            ...
            return redirect()->to('/admin/profile')->with('success', 'Foto profil berhasil dihapus.');
        }

        return redirect()->to('/admin/profile')->with('error', 'Tidak ada foto profil untuk dihapus.');
    }
}
