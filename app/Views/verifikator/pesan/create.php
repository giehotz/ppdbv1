...
<div class="bg-white rounded-lg shadow-md overflow-hidden max-w-4xl mx-auto">
    ...
    <form action="<?= base_url('verifikator/pesan/store') ?>" method="POST" class="p-6">
        <?= csrf_field() ?>
        ...
        <div class="flex justify-end gap-2">
            <a href="<?= base_url('verifikator/pesan') ?>" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded transition duration-200">
                Batal
            </a>
